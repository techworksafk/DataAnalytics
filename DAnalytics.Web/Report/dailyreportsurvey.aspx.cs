...
{
    public partial class dailyreportsurvey : BasePage.DAnalBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            BoreHoleTreeSurvey1.OnGenerateReport += new UserControls.GenerateReport(BoreHoleTree1_OnGenerateReport);
        }
