<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Site.Master" AutoEventWireup="true"
    CodeBehind="OLDProj_ErrorRatio.aspx.cs" Inherits="DAnalytics.Web.Report.ErrorRatio" %>
        ...
        <div class="inner_content_holder">
            ...
            <div class="multi_row_elements">
                ...
                <div class="cls">
                    ...
                    <input type="hidden" runat="server" id="hdnReportName" />
                </div>
                <script language="javascript" type="text/javascript">
                    ...
                    function PrintReport() {
                        ...
                        var ReportName = $("[id$='hdnReportName']").val();
                        var RptGroupID = $("[id$='ddlReportGroup']").val();
                        var CompanyId = $("[id$='ddlAdjCompany']").val();
                        return OpenReportViewer(ReportName, "&From=" + From + "&To=" + To + "&UID=" + UID + "&RptGroupID=" + RptGroupID + "&CID=" + CompanyId);
                    }
