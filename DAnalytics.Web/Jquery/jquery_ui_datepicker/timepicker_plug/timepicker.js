...
*/
jQuery.fn.datetime = function(options) {
    ...
    return this.each(function() {
        ...
        function writeDate(text, type) {
            ...
            //This code is only for showreuest and showdetails pages
            if (options.PageName == "SROpenDate" || options.PageName == "SDOpenDate") {
                AdjustInbuild($('#pickerplug').data('lastdate'), $('#pickerplug').data('lasttime'));
            }
            if (options.PageName == "SRCloseDate" || options.PageName == "SDCloseDate") {
                AdjustOutDate($('#pickerplug').data('lastdate'), $('#pickerplug').data('lasttime'));
            }            
        }
